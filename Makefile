...
#    Updated: 2019/09/15 10:57:16 by eleonard         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

ALL_OBJ =       ft_atoi.o 			ft_bzero.o 			ft_strchr.o \
         	    ft_check_overlap.o	ft_isalnum.o		ft_isalpha.o \
         		ft_isascii.o 		ft_isdigit.o		ft_isprint.o \
         		ft_memalloc.o		ft_memccpy.o		ft_memchr.o \
         		ft_memcmp.o			ft_memcpy.o			ft_memdel.o \
         		ft_memmove.o		ft_memset.o			ft_putchar.o \
         		ft_putendl.o		ft_putnbr.o			ft_putstr.o \
         		ft_strcat.o			ft_strclr.o			ft_strcmp.o \
         		...
         		ft_strnew.o			ft_strsplit.o		ft_strstr.o \
         		ft_strsub.o			ft_strtrim.o		ft_tolower.o \
         		ft_toupper.o		ft_strrchr.o		ft_strnstr.o \
				ft_itoa.o			ft_lstnew.o			ft_lstadd.o \
				ft_lstdelone.o		ft_lstdel.o			ft_lstiter.o \
				ft_lstmap.o			ft_lstaddtoend.o	ft_putchar_fd.o \
				ft_putstr_fd.o		ft_putendl_fd.o		ft_putnbr_fd.o 

ALL_FT =        ft_atoi.c 			ft_bzero.c 			ft_strchr.c \
